...
→ "Hjärtan" Magiskt verktyg ←
    ...
    → "Sparkles" Magic tool ←
        ...
        → Lower: Colors ←
            ...
            quick access to the "color picker" option. Hold the [Kontroll] key
        ...
        e."Text" and "Label" Tools ←
            ...
            → "Text" kontra "Etikett" ←
                ...
                (Use they [Backsteg] key to erase characters, and other keys to
                add text to the label; click in the canvas to reposition the
            ...
            → International Character Input ←
                ...
                the key to toggle or cycle modes, are listed below.
                  ...
                  * Japanese — Romanized Hiragana and Romanized Katakana —
                    höger [Alt]-knapp or left [Alt] key
        ...
        f."Fill" Tool ←
            ...
            with a color of your choice. Three fill options are offered:
              ...
              x Eraser — click once to erase an area, exposing the solid color
                ...
                "Eraser" Tool and Övriga kontroller > 'Startbilder' &
                Mallbilder.)
        ...
        h."Eraser" Tool ←
            ...
            or a 'Template' image. (See Available Tools > Övriga kontroller >
            "New" Command.)
        ...
        a."Undo" and "Redo" Commands ←
            ...
            ⌨ Note: You can also press [Kontroll / ⌘] + [Z] on the keyboard to
            Ångra.
            ...
            ⌨ Note: You can also press [Kontroll / ⌘] + [R] on the keyboard to
            Gör om.
        ...
        b."New" Command ←
            ...
            ⌨ Note: You can also press [Kontroll / ⌘] + [N] on the keyboard to
            start a new drawing.
            ...
            → Special Solid Background Color Choices ←
                ...
                below the canvas when drawing a picture. See Huvudskärm >
            ...
            'Startbilder' & Mallbilder ←
                ...
                "Magiskt" verktyg (specialeffekter) > Flip and Spegel.)
        ...
        c."Open" Command ←
            ...
            ⌨ Note: You can also press [Kontroll / ⌘] + [O] on the keyboard to
        ...
        d."Save" Command ←
            ...
            ⌨ Note: You can also press [Kontroll / ⌘] + [S] on the keyboard to
            save.
        ...
        f."Slides" Command (under "Open") ←
            ...
            → Playback in Tux Paint ←
                ...
                the [Pil höger] — or click the 'Next' button at the lower left
                — to manually advance to the next slide. Press [Left arrow] to
        ...
        g."Quit" Command ←
            ...
            [Kontroll / ⌘] + [Escape] may be used to quit.
        ...
        → Linux / Unix ←
            ...
            browser (e.g., GNOME-filer eller Dolphin).)
        ...
        The first line ("tuxpaint-import farmor.jpg") is the command to run.
        ...
        To learn more, visit the "Hjälp oss" page of the official Tux Paint
