...
→ "Hearts" Magic tool ←
    ...
    → "Sparkles" Magic tool ←
        ...
        → Më Poshtë: Ngjyra ←
            ...
            quick access to the "color picker" option. Hold the [Tasti
            Kontroll] key while clicking, and the color under the mouse cursor
            will be shown at the bottom. You may drag around to canvas to find
            the color you want. When you release the mouse button, the color
            under the cursor will be selected. If you release the mouse outside
            of the canvas (e.g., over the "Tools" area), the color selection
            will be left unchanged. (This is similar to clicking the "Back"
            button that's available when bringing up the "color picker" option
        ...
        (Shembull ndihmëze: “Zgjidhni një formë. Klikoni që të zgjidhni
        qendrën, tërhiqeni, mandej lëreni, kur të ketë madhësinë që doni.
        Lëvizni përreth që ta rrotulloni dhe klikoni që të vizatohet.”)
        ...
        b.Mjeti “Stampë” (Vula Gome) ←
            ...
            → Rrotullim Stampash ←
                ...
                learn about the "rrotullim stampash" ("stamprotation") option.
        ...
        e.Mjete “Tekst” dhe “Etiketa” ←
            ...
            Press [Tasti Enter] or [Tasti Return] and the text will be drawn
            onto the picture and the cursor will move down one line.

            Alternatively, press [Tasti Tab] and the text will be drawn onto
            ...
            → “Tekst” krahasuar me “Etiketë” ←
                ...
                [Tasti Tab] key to cycle through all the labels, and the [Tasti
                Enter] or [Tasti Return] key to select one — and you may then
                edit the label. (Use they [Tasti Backspace] key to erase
                characters, and other keys to add text to the label; click in
                the canvas to reposition the label; click in the palette to
                change the color of the text in the label; etc.)
            ...
            → Futje Shenjash Ndërkombëtare ←
                ...
                the key to toggle or cycle modes, are listed below.
                  ...
                  * Japonisht — Hiragana të romanizuara dhe Katakana të
                    romanizuara — tasti [Alt] i djathtë or tasti [Alt] i majtë
                  * Korean — Hangul 2-Bul — tasti [Alt] i djathtë or tasti
                    [Alt] i majtë
                  * Traditional Chinese — tasti [Alt] i djathtë ose tasti [Alt]
                    i majtë
        ...
        f.Mjeti “Mbushje” ←
            ...
            with a color of your choice. Three fill options are offered:
              ...
              x Eraser — click once to erase an area, exposing the solid color
                ...
                the drawing was based. (See Mjete të Mundshme > Mjete Vizatimi
                > Mjeti “Gomë” and Kontrolle të Tjera > Figura “Fillesë” &
                Gjedhe.)
        ...
        h.Mjeti “Gomë” ←
            ...
            or a 'Template' image. (See Mjete të Mundshme > Kontrolle të Tjera
            > Urdhri “I ri”.)
        ...
        a.Urdhrat “Ribëje” dhe “Zhbëje” ←
            ...
            ⌨ Note: You can also press [Tasti Kontroll / ⌘] + [Z] on the
            keyboard to Zhbëje.
            ...
            ⌨ Note: You can also press [Tasti Kontroll / ⌘] + [R] on the
            keyboard to Ribëje.
        ...
        b.Urdhri “I ri” ←
            ...
            new drawing. (See Mjete të Mundshme > Mjete Vizatimi > Mjeti “Gomë”
            .)

            ⌨ Note: You can also press [Tasti Kontroll / ⌘] + [N] on the
            keyboard to filloni një vizatim i ri.
            ...
            → Special Solid Background Color Choices ←
                ...
                below the canvas when drawing a picture. See Skena Kryesore >
                Më Poshtë: Ngjyra > Special color options for details.
            ...
            Figura “Fillesë” & Gjedhe ←
                ...
                reappear. (See Mjete të Mundshme > Mjete Vizatimi > Mjeti
                “Gomë” and Mjeti “Mbushje”.)

                The 'Flip' and 'Mirror' Magic tools affect the orientation of
                the 'Starter' or 'Template', as well. (See Mjete të Mundshme >
                Mjeti “Magjik” (Efekte Speciale) > Ktheje në anë tjetër and
                Pasqyroje.)
        ...
        c.Urdhri “Hape” ←
            ...
            Prej skenës “Hap” mundeni edhe të:
              x Klikon butonin blu “Diapozitiva” (projektor diapozitivash)
                poshtë majtas, për të kaluar nën mënyrën “shfaqje
                diapozitivash”. Për hollësi, shihni “Diapozitiva”,.

              x Klikoni butonin blu “Gjedhe” poshtë majtas, për ta shndërruar
                në një gjedhe të re figurën e përzgjedhur, e cila mund të
                përdoret si bazë për vizatime të reja.

                📜 Note: The Template creation feature was added to Tux Paint in
                version 0.9.31. Për të mësuar se si të krijohen Gjedhe jashtë
                Tux Paint-it, shihni Zgjerim i Tux Paint-it
            ...
            ⌨ Note: You can also press [Tasti Kontroll / ⌘] + [O] on the
            keyboard to hapni dialogun “Hap”.
        ...
        d.Urdhri “Ruaje” ←
            ...
            ⌨ Note: You can also press [Tasti Kontroll / ⌘] + [S] on the
            keyboard to save.
        ...
        e.Urdhri “Shtype” ←
            ...
            [Mundësi] on Macs) while clicking the 'Print' button to get a
            ...
            → Rregullime Shtypësi ←
                ...
                However, if you hold the [Alt] (or [Mundësi]) key on the
            ...
            → Mundësi Dialogu Shtypësi ←
                ...
                instead of "lpr") if the [Alt] (or [Mundësi]) key is held while
                ...
                file. Conversely, you can prevent the [Alt]/[Mundësi] key from
        ...
        f.Urdhri “Diapozitiva” (nën “Hape”) ←
            ...
            → Luajtje në Tux Paint ←
                ...
                During the slideshow, press [Tasti Hapësirë], [Tasti Enter] or
                [Tasti Return], or the [Shigjeta djathtas] — or click the
                'Next' button at the lower left — to manually advance to the
                next slide. Press [Shigjeta majtas] to go back to the previous
                slide.

                Press [Tasti Escape], or click the 'Back' button at the lower
                right, to exit the slideshow and return to the slideshow image
                selection screen.
            ...
            → Eksportim i një Gif-i të animuar ←
                ...
                Pressing [Tasti Escape] during the export process will abort
                the process, and return you to the 'Slideshow' dialog.
        ...
        g.Urdhëri “Dil” ←
            ...
            pushing the [Tasti Escape] key will quit Tux Paint.
            ...
            [Tasti Escape] key, may be disabled, via the "noquit" option.
        ...
        as the [Tasti Escape] key, switching to the Paint tool, invoking Undo
        and Redo operations, etc.). See the Options documentation for more
        details.
        ...
        Note: The default resolution is 800x600.) See "Llogaritje Përmasash
        Figure", below.
        ...
        → Përdorim i Tux Paint-it: ←
              ...
              x Dokumentim i Mjetit “Magjik” (“magic-docs”)
        ...
        To learn more, visit the "Kontakt" page of the official Tux Paint
        ...
        To learn more, visit the "Ndihmonani" page of the official Tux Paint
