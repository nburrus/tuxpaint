                  ...
                  else
                    {
                      ...
                      if (cur_tool == TOOL_BRUSH)
                      ...
                      else if (cur_tool == TOOL_TEXT || cur_tool == TOOL_LABEL)
                        {
                          ...
                          if (onscreen_keyboard && HIT(kbd_rect) && !(cur_tool == TOOL_LABEL && (cur_label == LABEL_SELECT || cur_label == LABEL_APPLY)))
                            {
...
static int do_save(int tool, int dont_show_success_results)
{
  ...
  safe_snprintf(tmp, sizeof(tmp), "saved/%s%s", file_id, FNAME_EXTENSION);
          ...
          if (event.type == SDL_QUIT)
          ...
          else if (event.type == SDL_MOUSEMOTION)
            {
              ...
              if ((btn_clicked >= 0 && btn_clicked < NUM_MIXER_COLORS) ||
                  ...
                  (btn_clicked == COLOR_MIXER_BTN_UNDO && color_mix_cur_undo != color_mix_oldest_undo) ||
