...
/* Groups are per the MAGIC_TYPE_... values
   returned by the tools' `..._get_group()` functions: */
$tools = array(
  ...
  array(
    ...
    'tools' => array(
      ...
      array('name'=>'TV',
       ...
       'author'=>array($AUTHOR_ADAMR, $AUTHOR_KENDRICK)),
    ),
  ),
  ...
  array(
    'group_name' => 'Picture Decorations',
    'tools' => array(
      array('name'=>'Blinds',
...
foreach ($tools as $g) {
  ...
  foreach ($g['tools'] as $t) {
    ...
    $out .= "<h2 align=\"center\">Group: $group_name</h2>\n";
    $out .= "<h3 align=\"center\">By ";
